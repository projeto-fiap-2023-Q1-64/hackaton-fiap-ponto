...
public class PontoApiController {
    ...
    @SneakyThrows
    @ApiOperation(value = "Busca pontos por data", notes = "Este endpoint busca as informações de pontos por data")
    public PontoResponseDTO buscaPorData(@RequestParam Date data) {
        return pontoAdapterController.buscaPorData(data);
    }
}
